  ...
  const handleRentBike = (bike: Bike) => {
    if (!user) {
      ...
      const shouldRedirect = confirm(
        "Please sign in to rent a bike. Would you like to go to the login page?",
      );
      if (shouldRedirect) {
        router.push("/login");
      }
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium border ${getStationColor(bike.station)}`}
                    >
                      {bike.station}
                    </span>
                  ...
                  {/* Availability Status */}
                  <div
                    className={`flex items-center gap-2 mb-3 p-2 rounded-lg ${availabilityStatus.bgColor}`}
                  >
                    <StatusIcon
                  ...
                  {bike.totalSlots && (
                    <div className="flex items-center justify-between mb-3 text-xs text-gray-600">
                      <span>
                        {t("bike.availableSlots")}: {bike.availableSlots}/
                        {bike.totalSlots}
                      </span>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-xs text-primary-600 font-medium">
                      • {bike.distance.replace("km", t("bike.km"))}
                    </span>
                  </div>
