        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <button 
              ...
              className="relative bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white px-12 py-4 text-lg font-bold rounded-xl shadow-lg hover:shadow-xl border-2 border-primary-500 hover:border-primary-600 transition-all duration-200 transform hover:scale-105 active:scale-95 cursor-pointer group"
            >
