  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingStation) {
        ...
        alert(
          `Successfully created station "${formData.name}" with ${formData.bikeCount} bike(s)`,
        );
      }
    ...
    if (
      ...
      try {
        ...
        const updatedBicycles = bicycles.filter(
          (bicycle: any) => bicycle.name !== stationName,
        );
        localStorage.setItem(
          "pedalnepal_bicycles",
          JSON.stringify(updatedBicycles),
        ...
        setTimeout(() => {
          setStations((prev) =>
            prev.filter((station) => station.name !== stationName),
          );
        }, 0);
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Create new stations and manage slots, pricing, and operations
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="bg-gradient-to-r from-green-500 to-blue-600 px-8 py-6">
              ...
              <p className="text-green-100 mt-2">
                {editingStation
                  ? "Update station details and pricing"
                  : "Add a new bike rental station with bikes"}
              </p>
            </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        bikeCount: Number(e.target.value),
                      })
                    }
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Number of bikes to add to this station (1-50)
                  </p>
                </div>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <button
                          onClick={() =>
                            router.push(
                              `/admin/manage-slots?stationId=${station.name}_${station.location}`,
                            )
                          }
                  ...
                  <div className="bg-white rounded-lg p-3 border border-green-200">
                    ...
                    <div className="font-semibold text-green-600">
                      ...
                      {stations.length > 0
                        ? Math.round(
                            stations.reduce(
                              (sum, station) => sum + station.hourlyRate,
                              0,
                            ) / stations.length,
                          )
                        : 0}
                  ...
                  <div className="bg-white rounded-lg p-3 border border-purple-200">
                    ...
                    <div className="font-semibold text-purple-600">
                      ...
                      {stations.length > 0
                        ? Math.round(
                            stations.reduce(
                              (sum, station) => sum + station.dailyRate,
                              0,
                            ) / stations.length,
                          )
                        : 0}
