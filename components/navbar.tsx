      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-2">
          ...
          <div className="flex flex-col items-center">
            <NextLink
              className="flex flex-col items-center gap-1 pt-2 group"
              href="/"
            >
              ...
              <div className="flex flex-col items-center -mt-2">
                <p className="font-bold text-primary-700 freestyle-script text-xl group-hover:text-primary-800 transition-colors"></p>
              </div>
            </NextLink>
            {!loading && user && (
              <div className="mt-1">
