            ...
            <div className="space-y-3">
              ...
              <div className="bg-primary-50 border border-primary-200 rounded-lg p-3">
                <p className="text-xs text-primary-700">
                  <strong>Why we need your verification ID:</strong> For
                  security and verification purposes. Your ID will be securely
                  stored and verified within 24 hours.
                </p>
              </div>
            </div>
          </div>
        ...
        <p className="text-neutral-600 text-sm">
          {mode === "login" ? (
            <>
              ...
              <Link
                href="/signup"
                className="text-primary-600 hover:text-primary-700 font-semibold transition-colors underline decoration-2 underline-offset-2"
              >
                Sign up here
              </Link>
            </>
